    ...
    return [
      {
        ...
        create() {
            ...
            addChatButton.textContent = "Add to Chat";
            addChatButton.className = "font-snas p-1 px-2 hover:bg-foreground/10 rounded-sm";

            const quickEditButton = document.createElement("button");
            quickEditButton.className = "font-snas p-1 px-2 hover:bg-foreground/10 rounded-sm flex items-center gap-1";
