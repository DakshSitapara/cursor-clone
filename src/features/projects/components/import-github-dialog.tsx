...
const formSchema = z.object({
  url: z.url("Invalid URL, please provide a valid URL"),
});
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Enter the URL to the GitHub repository you want to import. A new
            project will be created with the contents of the repository.
          </DialogDescription>
        </DialogHeader>
        <form
          onSubmit={(e) => {
