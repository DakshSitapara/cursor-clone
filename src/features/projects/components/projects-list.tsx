...
import { AlertCircleIcon, GlobeIcon, Loader2Icon, ArrowRightIcon } from "lucide-react";
    ...
    return(
        <div className="flex flex-col gap-2">
            ...
            <Button
                variant="outline"
                asChild
                className="h-auto items-start justify-start flex flex-col gap-2 p-4 bg-background border rounded-none"
            >
