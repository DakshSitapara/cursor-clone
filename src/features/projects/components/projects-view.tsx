        ...
        <div className="bg-sidebar flex flex-col items-center justify-center min-h-screen p-6 md:p-16">
            <div className="w-full max-w-sm mx-auto flex flex-col gap-4 items-center">
                ...
                <div className="flex justify-between gap-4 w-full items-center">
                    ...
                    <picture>
                    <img src="/logo.svg" alt="Cursor-Clone" className="hidden dark:block size-[32px] md:size-[46px]" />
                    <img src="/logo-alt.svg" alt="Cursor-Clone" className="block dark:hidden size-8 md:size-11.5" />
                    </picture>
